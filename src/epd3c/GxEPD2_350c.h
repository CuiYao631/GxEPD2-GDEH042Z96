...
#ifndef _GxEPD2_350c_H_
#define _GxEPD2_350c_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_350c : public GxEPD2_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 184;
    static const uint16_t WIDTH_VISIBLE = WIDTH;
    static const uint16_t HEIGHT = 384;
    static const GxEPD2::Panel panel = GxEPD2::GDEW0350Z10;
    ...
    // constructor
    GxEPD2_350c(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
